...
<head>
  ...
  <title>Furkan'ın Bloğu| Yönetim Paneli </title>
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <div class="separator">
              <p class="change_link">
               ...
               <?php 
              //eğer durum no ise veriler eşleşmemiştir o yüzden kullanıcı yoktur
               if(isset($_GET['durum'])){
                if($_GET['durum']=="no") {
                 
                 echo "Kullanıcı Bulunamadı...";

               } elseif ($_GET['durum']=="exit") { // güvenli çıkış
           ...
           <div>
            <h1><i class="fa fa-paw"></i> Furkan'ın Blogu</h1>
            <p>furkaninblogu.com</p>
          </div>
        </div>
      </form>
