        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              <!-- Blog kategori seçme başlangıç -->
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Blog Kategori <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="blog_kategori"  required="required" placeholder="Blog kategori giriniz" class="form-control col-md-7 col-xs-12">
                </div>
              </div>

              <!-- Blog Kategori seçme Bitiş -->
